insert into statuses(id, user_id, latitude, longitude, name, text, url, start_date, end_date, kind, category) values
('bc6cbd1c-dcd9-447f-8831-f59d88c883fa', 'f908854b-93f5-48bc-9213-7abcb1169d48', 12.345, 67.89, 'salsa open air', 'good place!!!', 'https://www.facebook.com/LatinDanceOpenAir/', '2016-09-15T01:34:19.399Z', '2016-09-15T01:34:19.399Z', 'event', 'LECTURE');
insert into images(url, user_id) values
('http://images.freeimages.com/images/previews/682/curve-ahead-3-1384097.jpg', 'f908854b-93f5-48bc-9213-7abcb1169d48');
